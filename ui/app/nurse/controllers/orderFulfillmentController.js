...
angular.module('bahmni.nurse').controller('OrderFulfillmentController', ['$scope', '$rootScope', '$stateParams', '$state', '$q', 'patientContext', 'orderService', 'observationService',
    'orderTypeService', 'sessionService', 'encounterService', 'spinner', 'messagingService', 'appService', '$anchorScroll', 'nurseObservationConfig', 'contextChangeHandler',
    function ($scope, $rootScope, $stateParams, $state, $q, patientContext, orderService, observationService,
       ...
       // $scope.formName = $stateParams.orderType + Bahmni.Common.Constants.fulfillmentFormSuffix;
        ...
        console.log($scope.nurseObservationConfig);
        ...
        $scope.$on("event:saveObservations", function () {
            ...
            var savePromise = observationService.save($scope.nurseObservationConfig, $scope.patient, sessionService.getLoginLocationUuid());
